...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "social_login@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "social_login API";

        private String description = "social_login API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "social_login";
